    ...
    config = function()
      ...
      require("incline").setup({
        ...
        render = function(props)
          ...
          local git_diff = get_git_diff(props)
          local diagnostic_label = get_diagnostic_label(props)
          local is_git_diff_empty = #git_diff == 0
          local is_diagnostic_empty = #diagnostic_label == 0

          if is_git_diff_empty and is_diagnostic_empty then
            return {}
          end

          if is_git_diff_empty then
            return { diagnostic_label }
          end

          if is_diagnostic_empty then
            return { git_diff }
          end
